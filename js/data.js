...
// 월별 라벨
var ML = ['25.01','25.02','25.03','25.04','25.05','25.06','25.07','25.08','25.09','25.10','25.11','25.12','26.01'];
var MN = ['2025.01','2025.02','2025.03','2025.04','2025.05','2025.06','2025.07','2025.08','2025.09','2025.10','2025.11','2025.12','2026.01'];

// 월별 신규 환자 수
var patients = [12,11,4,8,6,8,11,5,5,8,4,5,8];
// 월별 매출 (원)
var revenue = [11916220,15345060,9383880,2372350,7886370,14923740,8360870,4065710,7858310,15875310,5424490,4595160,29574620];
// 월별 유튜브 조회수
var views = [69517,90544,72898,140268,84631,122738,113868,127709,155199,122380,78073,131168,113581];
...
// --- localStorage 연동 (v6) ---
try { const l=localStorage.getItem('dashboardData_v6'); if(l){ const p=JSON.parse(l); Object.keys(p).forEach(k => { window[k] = p[k]; }); } } catch(e){console.error(e);}